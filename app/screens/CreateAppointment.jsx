...
const AppointmentDateScreen = () => {
  ...
  return (
    ...
    >
      ...
      {date && (
        <View className="w-full h-24 flex-col items-start justify-center mt-12 px-4">
          <Text className="text-[14px] font-semibold text-gray-400 mb-2 mt-4">
            Slots Available
          </Text>
