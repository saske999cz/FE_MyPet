    ...
    <SafeAreaView className="bg-[#E58E37] h-full">
      <ScrollView contentContainerStyle={{height:"100%"}}>
        <View className="w-full h-full justify-start px-4">
          ...
          <Text className="font-semibold text-2xl text-white mt-16 w-[full] text-center">Sign in</Text>
          ...
          <CustomButton title="Sign In" handlePress={submit} containerStyles="mt-8 bg-[#3D1E14]" textStyles="text-gray-50" isLoading={isSubmitting}/>
          <View className="justify-center pt-5 flex-row gap-2">
            <Text className="text-lg text-gray-50">Don't have account?</Text>
            <Link href="/sign-up" className="text-lg text-[#3D1E14] font-semibold">Sign Up</Link>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
